...
import { listaCategorias } from '../../assets/data/listaCategorias';
import { ReactComponent as IconoDown } from '../../assets/img/down.svg'
                    ...
                    <Opciones>
                        {
                            listaCategorias.map( categoria => (
                                ...
                                ><IconoCategoria nombre={categoria.id} /> {categoria.texto}</Opcion>
                            ))
                        }
                    </Opciones>
            }
